...
// On submission, clear the input field and add the entry to the guestbook.
  ...
  // colors = 5 different shades of dark purple
  // this allows is to showcase it's different on each manual refresh of the page
  var colors = ["#2E0854", "#3D105E", "#4B1668", "#591D72", "#67237C"];
